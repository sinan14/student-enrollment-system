      ...
      if ($val == 'Assam') {
        ...
        $(function () {
          ...
          for (var i = 0; i < assam.length; i++) {
            options +=
              '<option value="' + assam[i] + '">' + assam[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
      ...
      if ($val == 'Bihar') {
        ...
        $(function () {
          ...
          for (var i = 0; i < bihar.length; i++) {
            options +=
              '<option value="' + bihar[i] + '">' + bihar[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
      ...
      if ($val == 'Dadra and Nagar Haveli') {
        ...
        $(function () {
          ...
          for (var i = 0; i < dadra.length; i++) {
            options +=
              '<option value="' + dadra[i] + '">' + dadra[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
      ...
      if ($val == 'Daman and Diu') {
        ...
        $(function () {
          ...
          for (var i = 0; i < daman.length; i++) {
            options +=
              '<option value="' + daman[i] + '">' + daman[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
      ...
      if ($val == 'Jammu and Kashmir') {
        ...
        $(function () {
          ...
          for (var i = 0; i < jammu.length; i++) {
            options +=
              '<option value="' + jammu[i] + '">' + jammu[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
      ...
      if ($val == 'Punjab') {
        ...
        $(function () {
          ...
          for (var i = 0; i < punjab.length; i++) {
            options +=
              '<option value="' + punjab[i] + '">' + punjab[i] + '</option>';
          }
          $('#secondlist').html(options);
        });
      }
